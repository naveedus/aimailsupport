...
document.querySelector('#llmTemperature').addEventListener('input', (event) => {
    const destination = (document.querySelector('label[for=llmTemperature] span') as HTMLInputElement)
...
document.querySelector('#optionsForm').addEventListener('submit', async (event) => {
    ...
    const configs: ConfigType = {
        ...
        temperature: parseFloat((document.querySelector('#llmTemperature') as HTMLInputElement).value),
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Temperature -->
    (document.querySelector('#llmTemperature') as HTMLInputElement).value = (configs.temperature || 1).toString();
    (document.querySelector('label[for=llmTemperature] span') as HTMLInputElement).innerText = parseFloat((document.querySelector('#llmTemperature') as HTMLInputElement).value).toFixed(2)
    // <-- temperature
